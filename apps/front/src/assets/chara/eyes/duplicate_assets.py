...
def duplicate_assets(source_folder, output_base_folder, num_duplicates=12, 
    ...
    for i in range(num_to_create):
        ...
        # Output file paths (keep original names)
        output_json = os.path.join(output_folder, f"{json_basename}.json")
        output_png = os.path.join(output_folder, f"{png_basename}.png")
